...
void HalDebug::alustaLogimist( int debugFile, int debugVideo){
...
void HalDebug::logi( int debugFile, int debugVideo, IplImage* img, Image::Object* pall, int analog[], int digital[], int pwms[], int state, int kaader, int ms ) {
    if( debugVideo && cvVW ) {
...
void HalDebug::lopetaLogimine( int debugFile, int debugVideo ){
    if( debugVideo && cvVW ){
